package com.wuka.ltv.ui.adapter;
...
import com.wuka.ltv.AppDatabase;
import com.wuka.ltv.R;
import com.wuka.ltv.bean.Bean;
...
import com.wuka.ltv.ui.adapter.holder.BaseHolder;
import com.wuka.ltv.ui.adapter.holder.ChannelHolder;
import com.wuka.ltv.ui.adapter.holder.TypeHolder;
import com.wuka.ltv.utils.Notify;
...
public class PlayerAdapter extends RecyclerView.Adapter<BaseHolder> {
	...
	public int onMoveUp(boolean play) {
		...
		if (isType(position) && play) onMoveUp(true);
		if (play) setChannel();
		else setSelected();
		return position;
	}
	...
	public int onMoveDown(boolean play) {
		...
		if (isType(position) && play) onMoveDown(true);
		if (play) setChannel();
		else setSelected();
		return position;
	}
